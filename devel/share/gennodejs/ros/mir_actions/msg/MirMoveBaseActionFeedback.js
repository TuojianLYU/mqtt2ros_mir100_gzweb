...
let MirMoveBaseFeedback = require('./MirMoveBaseFeedback.js');
let std_msgs = _finder('std_msgs');
let actionlib_msgs = _finder('actionlib_msgs');

//-----------------------------------------------------------

class MirMoveBaseActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new MirMoveBaseFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = MirMoveBaseFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new MirMoveBaseActionFeedback(null);
    ...
    data.feedback = MirMoveBaseFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += MirMoveBaseFeedback.getMessageSize(object.feedback);
    return length;
  }
  ...
  static md5sum() {
    ...
    return '0fc99ae551a2aa911fb5f6f57d3fd3ce';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MirMoveBaseActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = MirMoveBaseFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new MirMoveBaseFeedback()
    }
...
module.exports = MirMoveBaseActionFeedback;
